          ...
          <div className="glass p-8 animate-fade-in" style={{animationDelay: '0.1s'}}>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/cyprian-kanda-boit" className="p-2 bg-secondary/60 rounded-lg hover:bg-accent/20 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://twitter.com/cyp_dev" className="p-2 bg-secondary/60 rounded-lg hover:bg-accent/20 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M23 3.00005C22.0424 3.67552 20.9821 4.19216 19.86 4.53005C19.2577 3.83756 18.4573 3.34674 17.567 3.12397C16.6767 2.90121 15.7395 2.95724 14.8821 3.2845C14.0247 3.61176 13.2884 4.19445 12.773 4.95376C12.2575 5.71308 11.9877 6.61238 12 7.53005V8.53005C10.2426 8.57561 8.50127 8.18586 6.93101 7.39549C5.36074 6.60513 4.01032 5.43868 3 4.00005C3 4.00005 -1 13 8 17C5.94053 18.398 3.48716 19.099 1 19C10 24 21 19 21 7.50005C20.9991 7.2215 20.9723 6.94364 20.92 6.67005C21.9406 5.66354 22.6608 4.39276 23 3.00005Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/cypriankanda" className="p-2 bg-secondary/60 rounded-lg hover:bg-accent/20 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/cypriankanda" className="p-2 bg-secondary/60 rounded-lg hover:bg-accent/20 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-secondary/40 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-accent/50"
                    placeholder="cyprian.kanda@moringaschool.com"
                  />
                </div>
              </div>
